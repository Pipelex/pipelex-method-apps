...
/** Largest file a file input will send, measured in decoded bytes. */
 ...
 * Server Action with an opaque transport digest for every file in the 3.2–8 MB
 * band, i.e. inside the `MAX_FILE_BYTES` this module advertises, and made the
 ...
 *
 * The early exit in `useFileInputs` is not a second rule — it reads `MAX_FILE_BYTES`
