 ...
 * returns, matching the image types `make add-method` lets a scaffolded action
 * accept on the input side. An allow-list, not an `image/` prefix test: `image/svg+xml` renders as a
