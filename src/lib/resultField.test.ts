...
import { OUTPUT_FORM, PIPE_IO_CONTRACTS } from "@/test/fixtures/contracts/extract-entities";
import {
  OUTPUT_FORM as IMAGE_OUTPUT_FORM,
  PIPE_IO_CONTRACTS as IMAGE_CONTRACTS,
} from "@/test/fixtures/contracts/generate-image";
import {
  OUTPUT_FORM as TEXT_STATS_OUTPUT_FORM,
  PIPE_IO_CONTRACTS as TEXT_STATS_CONTRACTS,
} from "@/test/fixtures/contracts/text-stats";
